...
const { 
  ...
  hasParent 
} = require('../../shared/database.service');
const { generateBlueprintCompliantTest } = require('./enhancedTest.service');
// ✅ SHORT ANSWER FIX: Removed unused import - short answers now use standard generation
// const { generateShortAnswerTest } = require('./shortAnswerTest.service');
