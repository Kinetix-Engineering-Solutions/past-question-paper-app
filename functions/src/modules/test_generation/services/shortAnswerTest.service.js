const { generateSingleDocumentTest } = require('../../shared/shortAnswerSingleDoc.service');
const { safeArray, mapQuestionData } = require('../../../helpers/dataHelpers');
const { getParentQuestion, enrichQuestionWithParent, hasParent } = require('../../shared/database.service');
...
async function generateShortAnswerPQPTest(params) {
  ...
  try {
    ...
    if (parentId) {
      ...
      const { getChildQuestions } = require('../../shared/database.service');
