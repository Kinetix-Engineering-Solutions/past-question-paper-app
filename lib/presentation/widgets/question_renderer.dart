...
/// A widget that renders a question using the appropriate strategy
class QuestionRenderer extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<QuestionRenderer> createState() => _QuestionRendererState();
}

class _QuestionRendererState extends ConsumerState<QuestionRenderer> {
  ...
  void _initializeStrategy() {
    ...
    // Initialize the user answer state only for non-drag-and-drop questions
    if (widget.question.questionType != 'drag-and-drop') {
  ...
  void _checkAnswer() {
    ...
    // For drag-and-drop questions, the strategy widget handles its own submission
    if (widget.question.questionType == 'drag-and-drop') {
      return;
    }
  ...
  Widget build(BuildContext context) {
    // For drag-and-drop questions, render with minimal wrapper
    if (widget.question.questionType == 'drag-and-drop') {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(_validationError!, style: const TextStyle(fontSize: 14)),
              ],
            ),
          ),
