...
class Topic3DCarousel extends StatefulWidget {
  ...
  @override
  State<Topic3DCarousel> createState() => _Topic3DCarouselState();
}

class _Topic3DCarouselState extends State<Topic3DCarousel>
  ...
  List<Widget> _buildNeuronNodes(Size screenSize) {
    ...
    return List.generate(widget.topics.length, (index) {
      ...
      final nodeSize = isFocused ? 120.0 : 90.0;
  ...
  Widget _buildNeuronNode(int index, bool isFocused) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        if (isFocused) {
          // Select the topic
          widget.onTopicSelected(topic, index);
        } else {
...
/// Custom painter for drawing neural network connections between topic nodes
