...
class LatexText extends StatelessWidget {
  ...
  Widget _buildMixedContent(String text, TextStyle style) {
    ...
    final mathPattern = RegExp(r'([^a-zA-Z]*)([a-zA-Z]*\s*)(\d*[a-zA-Z]+[\^\{\}0-9]*[+\-=][^$]*)', multiLine: true);
  ...
  Widget _buildTextWithSpacing(String text, TextStyle style) {
    ...
    processedText = processedText.replaceAll(RegExp(r'solve\s*for'), 'solve for ');
  ...
  Widget _buildWrappedLatexContent(String text, TextStyle style, Iterable<RegExpMatch> matches) {
